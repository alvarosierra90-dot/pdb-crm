                ...
                <div style={{ display:'grid', gridTemplateColumns:'repeat(4, minmax(0,1fr))', gap:12, marginBottom:14, alignItems:'stretch' }}>
                  ...
                  <div className="dash-card" style={{ overflow:'visible' }}>
                    ...
                    <div style={{ padding:'12px 16px 14px', display:'flex', flexDirection:'column', gap:12 }}>
                      ...
                      {/* Personas · Empleados / Proveedores / Clientes con toggle Grupo/Tabla */}
                      <EquipoBloque bare
                        equipo={equipo}
                        canManage={canManage}
              ...
              <div className="rp-sec">
                ...
                <div className="ai-box">
                  ...
                  <div className="ai-text">
                    {esInversion
                      ? <>Demanda de inversión · ticket en análisis. <strong>Detectando ofertas en venta compatibles</strong> y posibles riesgos de yield.</>

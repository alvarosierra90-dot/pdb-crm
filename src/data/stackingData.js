...
export const BUILDINGS_BY_ACTIVO = {
  ...
  'MAD-OF-00189': [
    {
      ...
      arr:[
        {p:'P5',sup:1500,units:[{type:'ten',n:'Celonis',sup:1202,brk:'Oct 2025',brkColor:'var(--amber)'},{type:'vac',oferta:'OFR-0017',sup:298}]},
        {p:'P4',sup:1500,units:[{type:'ten',n:'Celonis',sup:1500,brk:'Oct 2025',brkColor:'var(--amber)'}]},
        {p:'P3',sup:1500,units:[{type:'ten',n:'Repsol',sup:767,brk:'Jun 2027',brkColor:'var(--green)'},{type:'vac',oferta:'OFR-0023',sup:733}]},
        {p:'P2',sup:1500,units:[{type:'ten',n:'Repsol',sup:1200,brk:'Jun 2027',brkColor:'var(--green)'},{type:'vac',oferta:'OFR-0023',sup:300}]},
        {p:'P1',sup:1500,units:[{type:'ten',n:'Desconocido',sup:1500,brk:'Ene 2026',brkColor:'var(--red)'}]},
        {p:'PB',sup:1500,units:[{type:'rt',n:'Cafetería',sup:380,brk:'Ene 2029',brkColor:'var(--text4)'},{type:'com',n:'Hall / Común',sup:220},{type:'vac',oferta:'OFR-0017',sup:900}]},
  ...
  'ALC-OF-00231': [
    ...
    },
    {
      ...
      arr:[
        ...
        {p:'P2',sup:3371,units:[{type:'vac',oferta:'OFR-0019',sup:1200},{type:'vac',oferta:null,sup:2171}]},
        {p:'P1',sup:3371,units:[{type:'vac',oferta:null,sup:3371}]},
  ...
  'MAD-OF-COL001': [{
    ...
    arr:[
      ...
      {p:'P2', sup:1125,units:[{type:'vac',oferta:'OFR-0013',sup:1125}]},
  ...
  'MAD-OF-MRL002': [{
    ...
    arr:[
      ...
      ...[5,4,3,2].map(n=>({p:`P${n}`,sup:1333,units:[{type:'vac',oferta:'OFR-0016',sup:1333}]})),
  ...
  'MAD-OF-GMP001': [{
    ...
    arr:[
      ...
      {p:'P3',sup:1059,units:[{type:'vac',oferta:'OFR-0015',sup:1059}]},
      {p:'P2',sup:1059,units:[{type:'vac',oferta:'OFR-0015',sup:1059}]},
